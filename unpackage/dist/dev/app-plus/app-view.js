...
Z([a,[[2,'+'],[1,'学校：'],[[2,'||'],[[2,'||'],[[6],[[7],[3,'item']],[3,'school_address']],[[6],[[7],[3,'item']],[3,'school_name']]],[1,'未知']]]])
...
var c0T=_mz(z,'image',['class',4,'src',1],[],e,s,gg)
_(f9T,c0T)
var hAU=_mz(z,'input',['autofocus',-1,'bindconfirm',6,'bindinput',1,'class',2,'confirmType',3,'data-event-opts',4,'data-type',5,'placeholder',6],[],e,s,gg)
_(f9T,hAU)
_(o8T,f9T)
var oBU=_mz(z,'navigator',['class',13,'openType',1],[],e,s,gg)
...
var lEU=_mz(z,'item-card',['bind:__l',17,'params',1,'tab',2,'vueId',3],[],e,s,gg)
_(oDU,lEU)
_(o6T,oDU)
_(r,o6T)
return r
...
var eHU=_mz(z,'uni-nav-bar',['backgroundColor',1,'bind:__l',1,'bind:tapLeft',2,'bind:tapRight',3,'border',4,'data-event-opts',5,'fixed',6,'leftIcon',7,'shadow',8,'statusBar',9,'title',10,'vueId',11,'vueSlots',12],[],e,s,gg)
var bIU=_v()
_(eHU,bIU)
if(_oz(z,14,e,s,gg)){bIU.wxVkey=1
var oJU=_mz(z,'image',['class',15,'slot',1,'src',2],[],e,s,gg)
_(bIU,oJU)
}
bIU.wxXCkey=1
_(tGU,eHU)
var xKU=_mz(z,'image',['class',18,'mode',1,'src',2],[],e,s,gg)
_(tGU,xKU)
var oLU=_n('scroll-view')
oLU.attr['scrollY']=true
var fMU=_n('view')
_rz(z,fMU,'class',21,e,s,gg)
var hOU=_mz(z,'image',['bindtap',22,'class',1,'data-event-opts',2,'mode',3,'src',4],[],e,s,gg)
_(fMU,hOU)
var oPU=_n('view')
...
_(lSU,eVU)
var bWU=_mz(z,'text',['bindtap',34,'class',1,'data-event-opts',2],[],e,s,gg)
...
var oZU=_mz(z,'view',['bindtap',40,'class',1,'data-event-opts',2],[],e,s,gg)
var f1U=_oz(z,43,e,s,gg)
_(oZU,f1U)
_(xYU,oZU)
var c2U=_mz(z,'view',['bindtap',44,'class',1,'data-event-opts',2],[],e,s,gg)
var h3U=_oz(z,47,e,s,gg)
_(c2U,h3U)
_(xYU,c2U)
_(cNU,xYU)
}
...
_(oLU,fMU)
var o4U=_n('view')
_rz(z,o4U,'class',48,e,s,gg)
var c5U=_v()
_(o4U,c5U)
if(_oz(z,49,e,s,gg)){c5U.wxVkey=1
var a8U=_n('view')
_rz(z,a8U,'class',50,e,s,gg)
var t9U=_n('view')
_rz(z,t9U,'class',51,e,s,gg)
var e0U=_n('text')
_rz(z,e0U,'class',52,e,s,gg)
var bAV=_oz(z,53,e,s,gg)
_(e0U,bAV)
_(t9U,e0U)
_(a8U,t9U)
var oBV=_n('view')
...
var xQV=_oz(z,69,e,s,gg)
_(oPV,xQV)
_(lKV,oPV)
_(oJV,lKV)
var oRV=_n('view')
_rz(z,oRV,'class',70,e,s,gg)
var fSV=_n('text')
_rz(z,fSV,'class',71,e,s,gg)
var cTV=_oz(z,72,e,s,gg)
_(fSV,cTV)
_(oRV,fSV)
var hUV=_n('text')
_rz(z,hUV,'class',73,e,s,gg)
var oVV=_oz(z,74,e,s,gg)
_(hUV,oVV)
_(oRV,hUV)
_(oJV,oRV)
var cWV=_n('view')
_rz(z,cWV,'class',75,e,s,gg)
var oXV=_n('text')
_rz(z,oXV,'class',76,e,s,gg)
var lYV=_oz(z,77,e,s,gg)
_(oXV,lYV)
_(cWV,oXV)
var aZV=_n('text')
_rz(z,aZV,'class',78,e,s,gg)
var t1V=_oz(z,79,e,s,gg)
_(aZV,t1V)
_(cWV,aZV)
_(oJV,cWV)
_(c5U,oJV)
...
var o6U=_v()
_(o4U,o6U)
if(_oz(z,80,e,s,gg)){o6U.wxVkey=1
var e2V=_n('view')
_rz(z,e2V,'class',81,e,s,gg)
var b3V=_n('view')
_rz(z,b3V,'class',82,e,s,gg)
var o4V=_mz(z,'image',['class',83,'src',1],[],e,s,gg)
_(b3V,o4V)
var x5V=_n('text')
_rz(z,x5V,'class',85,e,s,gg)
var o6V=_oz(z,86,e,s,gg)
_(x5V,o6V)
_(b3V,x5V)
_(e2V,b3V)
_(o6U,e2V)
...
var f7V=_n('view')
_rz(z,f7V,'class',87,e,s,gg)
var c8V=_n('view')
_rz(z,c8V,'class',88,e,s,gg)
var h9V=_mz(z,'image',['class',89,'src',1],[],e,s,gg)
_(c8V,h9V)
var o0V=_n('text')
_rz(z,o0V,'class',91,e,s,gg)
var cAW=_oz(z,92,e,s,gg)
_(o0V,cAW)
_(c8V,o0V)
_(f7V,c8V)
var oBW=_n('view')
_rz(z,oBW,'class',93,e,s,gg)
var lCW=_mz(z,'image',['class',94,'src',1],[],e,s,gg)
_(oBW,lCW)
var aDW=_n('text')
_rz(z,aDW,'class',96,e,s,gg)
var tEW=_oz(z,97,e,s,gg)
_(aDW,tEW)
_(oBW,aDW)
_(f7V,oBW)
_(o6U,f7V)
...
var l7U=_v()
_(o4U,l7U)
if(_oz(z,98,e,s,gg)){l7U.wxVkey=1
var eFW=_n('view')
_rz(z,eFW,'class',99,e,s,gg)
var bGW=_mz(z,'navigator',['class',100,'url',1],[],e,s,gg)
var oHW=_oz(z,102,e,s,gg)
_(bGW,oHW)
_(eFW,bGW)
var xIW=_mz(z,'navigator',['class',103,'url',1],[],e,s,gg)
var oJW=_oz(z,105,e,s,gg)
_(xIW,oJW)
_(eFW,xIW)
_(l7U,eFW)
}
...
_(fKW,cLW)
var oNW=_n('view')
_rz(z,oNW,'class',109,e,s,gg)
var cOW=_n('text')
_rz(z,cOW,'class',110,e,s,gg)
var oPW=_oz(z,111,e,s,gg)
_(cOW,oPW)
_(oNW,cOW)
var lQW=_n('text')
_rz(z,lQW,'class',112,e,s,gg)
var aRW=_oz(z,113,e,s,gg)
_(lQW,aRW)
_(oNW,lQW)
var tSW=_n('text')
_rz(z,tSW,'class',114,e,s,gg)
var eTW=_oz(z,115,e,s,gg)
_(tSW,eTW)
_(oNW,tSW)
_(fKW,oNW)
var bUW=_n('view')
_rz(z,bUW,'class',116,e,s,gg)
var oVW=_n('text')
_rz(z,oVW,'class',117,e,s,gg)
var xWW=_oz(z,118,e,s,gg)
_(oVW,xWW)
_(bUW,oVW)
var oXW=_n('text')
_rz(z,oXW,'class',119,e,s,gg)
var fYW=_oz(z,120,e,s,gg)
_(oXW,fYW)
_(bUW,oXW)
var cZW=_n('text')
_rz(z,cZW,'class',121,e,s,gg)
var h1W=_oz(z,122,e,s,gg)
_(cZW,h1W)
_(bUW,cZW)
_(fKW,bUW)
var o2W=_n('view')
_rz(z,o2W,'class',123,e,s,gg)
var c3W=_n('text')
_rz(z,c3W,'class',124,e,s,gg)
var o4W=_oz(z,125,e,s,gg)
_(c3W,o4W)
_(o2W,c3W)
var l5W=_n('text')
_rz(z,l5W,'class',126,e,s,gg)
var a6W=_oz(z,127,e,s,gg)
_(l5W,a6W)
_(o2W,l5W)
var t7W=_n('text')
_rz(z,t7W,'class',128,e,s,gg)
var e8W=_oz(z,129,e,s,gg)
_(t7W,e8W)
_(o2W,t7W)
_(fKW,o2W)
_(l7U,fKW)
...
_(oLU,o4U)
_(tGU,oLU)
var b9W=_mz(z,'uni-popup',['bind:__l',130,'class',1,'data-ref',2,'maskClick',3,'type',4,'vueId',5,'vueSlots',6],[],e,s,gg)
var o0W=_n('view')
_rz(z,o0W,'class',137,e,s,gg)
var xAX=_n('view')
_rz(z,xAX,'class',138,e,s,gg)
var oBX=_oz(z,139,e,s,gg)
_(xAX,oBX)
_(o0W,xAX)
var fCX=_mz(z,'textarea',['bindinput',140,'class',1,'data-event-opts',2,'data-type',3,'placeholder',4,'placeholderClass',5],[],e,s,gg)
_(o0W,fCX)
var cDX=_n('view')
_rz(z,cDX,'class',146,e,s,gg)
var hEX=_mz(z,'view',['bindtap',147,'class',1,'data-event-opts',2],[],e,s,gg)
var oFX=_oz(z,150,e,s,gg)
_(hEX,oFX)
_(cDX,hEX)
var cGX=_n('view')
_rz(z,cGX,'class',151,e,s,gg)
_(cDX,cGX)
var oHX=_mz(z,'view',['bindtap',152,'class',1,'data-event-opts',2],[],e,s,gg)
var lIX=_oz(z,155,e,s,gg)
_(oHX,lIX)
_(cDX,oHX)
_(o0W,cDX)
_(b9W,o0W)
